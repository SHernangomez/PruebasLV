...
//HV Parameters
    ...
    tx_id.Msg++;
    tx_data_4.Msg = (((bms->bms_mode == STANDBY) || (bms->bms_mode == ERROR)) ? 0 : bms->current*100 ); gui_msg_long(tx_id, tx_data_4, tx_eof);
//AIRs
    tx_id.Msg = 8;
...
//HCU_INFO
    ubyteMsg ch_info;   
    ch_info.Bit0 = 0;   ch_info.Bit1 = 0;   ch_info.Bit2 = 0;   ch_info.Bit3 = 0;   //BatAlm
    ch_info.Bit4 = 0;   ch_info.Bit5 = 0;   ch_info.Bit6 = 0;   ch_info.Bit7 = 0;   //BatState
    
    if(bms->error0count){           
        ch_info.Bit3 = 0; ch_info.Bit2 = 0; ch_info.Bit1 = 0; ch_info.Bit0 = 1;     //BatAlmLv = 1
    }
    else if (bms->error1count){     
        ch_info.Bit3 = 0; ch_info.Bit2 = 0; ch_info.Bit1 = 1; ch_info.Bit0 = 0;     //BatAlmLv = 2
    }
    else if (bms->error2count){     
        ch_info.Bit3 = 0; ch_info.Bit2 = 0; ch_info.Bit1 = 1; ch_info.Bit0 = 1;     //BatAlmLv = 3
    }
    
    if(bms->BatLife == 255) bms->BatLife = 0;
    else bms->BatLife ++;
    
//HCU_MAXV
    bms->MaxCelVolt = bms->vcell_max;   
    bms->MinCelVolt = bms->vcell_min;   
    
//HCU_MAXT
    int t=0;
    for(t=0; t<N_SLAVES; ++t){
        if(bms->tmax[t] > bms->MaxTemp){
            bms->MaxTemp = bms->tmax[t];
            bms->MaxTempNO = t;
        }
        if(bms->tmin[t] < bms->MinTemp){
            bms->MinTemp = bms->tmin[t];
            bms->MinTempNO = t;
        }
    }

    if(bms->fan1 == ON || bms->fan2 == ON || bms->fan3 == ON) bms->CoolingCtl = 1;
    else bms->CoolingCtl = 0;
    
//HCU_RELAY
    ubyteMsg ch_rly;
    ch_rly.Bit0 = 0;    ch_rly.Bit1 = 0;    //OnChrRlyStr    
    ch_rly.Bit2 = 0;    ch_rly.Bit3 = 0;    //PreRlyStr
    ch_rly.Bit4 = 0;    ch_rly.Bit5 = 0;    //NegRlyStr
    ch_rly.Bit6 = 0;    ch_rly.Bit7 = 0;    //PosRlyStr  
    
    if (bms->air_pos){ch_rly.Bit7 = 0; ch_rly.Bit6 = 1;}                    //PosRlyStr
    if (bms->air_neg){ch_rly.Bit5 = 0; ch_rly.Bit4 = 1;}                    //NegRlyStr
    if (bms->air_prech){ch_rly.Bit3 = 0; ch_rly.Bit2 = 1;}                  //PreRlyStr
    if (bms->air_pos && bms->air_neg){ch_rly.Bit1 = 0; ch_rly.Bit0 = 1;}    //OnChrRlyStr
    
    ubyteMsg ch_rly_2;
    ch_rly_2.Bit0 = 0;  ch_rly_2.Bit1 = 0;    //ChrONCC    
    ch_rly_2.Bit2 = 0;  //ChrOFFCC2    
    ch_rly_2.Bit3 = 0;  //ChrCommunication
    ch_rly_2.Bit4 = 0;  ch_rly_2.Bit5 = 0;  ch_rly_2.Bit6 = 0;  ch_rly_2.Bit7 = 0;    //ChrState

//CHARGER_INFO
    ubyteMsg ch_chinfo_1;
    ch_chinfo_1.Bit0 = 0;   //ChrDis   
    ch_chinfo_1.Bit1 = 0;   ch_chinfo_1.Bit2 = 0;   ch_chinfo_1.Bit3 = 0;   
    ch_chinfo_1.Bit4 = 0;   ch_chinfo_1.Bit5 = 0;   ch_chinfo_1.Bit6 = 0;   
    ch_chinfo_1.Bit7 = 0;   //MaxOutCurrent
    
    ubyteMsg ch_chinfo_2;
    ch_chinfo_2.Bit0 = 0;   ch_chinfo_2.Bit1 = 0;   ch_chinfo_2.Bit2 = 0;   ch_chinfo_2.Bit3 = 0;     
    ch_chinfo_2.Bit4 = 0;   ch_chinfo_2.Bit5 = 0;   ch_chinfo_2.Bit6 = 0;   ch_chinfo_2.Bit7 = 0;   //MaxOutCurrent
    
    ubyteMsg ch_chinfo_3;
    ch_chinfo_3.Bit0 = 0;   //Hardware_Fault   
    ch_chinfo_3.Bit1 = 0;   //Charger_Temperature
    ch_chinfo_3.Bit2 = 0;   //Input_Voltage
    ch_chinfo_3.Bit3 = 0;   //Battery_Access_Status
    ch_chinfo_3.Bit4 = 0;   //Communication_Status
    ch_chinfo_3.Bit5 = 0;   ch_chinfo_3.Bit6 = 0;   ch_chinfo_3.Bit7 = 0;
    
    if (bms->bms_mode == STANDBY){
    //HCU_INFO
        bms->BatVoltage = 0;
        bms->BatCurrent = 0;
        ch_info.Bit7 = 0;   ch_info.Bit6 = 0;   ch_info.Bit5 = 1;   ch_info.Bit4 = 0;     //BatState = 2
    //HCU_RELAY
        bms->OffChrRlyStr = 0;
    //HCU_POWER
        //bms->MaxChrPowerLimit = 0;
        //bms->MaxDisPowerLimit = 0;
    //CHARGING_LIMITS
        bms->ChrControl = 1;
    //CHARGER_INFO
        ch_chinfo_1.Bit0 = 1;
    }
    else if (bms->bms_mode == CHARGE){
    //HCU_INFO
        bms->BatVoltage = (uint16_t) bms->hv_batt*10;
        bms->BatCurrent = (uint16_t) bms->current*10;
        if (bms->air_pos == ON && bms->air_neg == ON){  
            ch_info.Bit7 = 1;   ch_info.Bit6 = 0;   ch_info.Bit5 = 0;   ch_info.Bit4 = 1; //BatState = 9  
        }
        else {  
            ch_info.Bit7 = 0;   ch_info.Bit6 = 1;   ch_info.Bit5 = 0;   ch_info.Bit4 = 0; //BatState = 4 
        }
    //HCU_RELAY
        bms->OffChrRlyStr = 64;
        ch_rly_2.Bit4 = 1;
    //HCU_POWER
        //bms->MaxChrPowerLimit = 153;
        //bms->MaxDisPowerLimit = 503;
    //CHARGING_LIMITS
        bms->ChrControl = 0;
    //CHARGER_INFO
        ch_chinfo_1.Bit0 = 0;
        ch_chinfo_2.Bit0 = 0;   ch_chinfo_2.Bit1 = 1;   ch_chinfo_2.Bit2 = 0;   
        ch_chinfo_2.Bit3 = 0;   ch_chinfo_2.Bit4 = 1;   ch_chinfo_2.Bit5 = 1;   //MaxOutCurrent = 50 = 5A      
    }
    
//HCU_ALARM
    ubyteMsg ch_alm_1;
    ch_alm_1.Bit0 = 0;    ch_alm_1.Bit1 = 0;    //ALM_CELL_UT    
    ch_alm_1.Bit2 = 0;    ch_alm_1.Bit3 = 0;    //ALM_CELL_OT
    ch_alm_1.Bit4 = 0;    ch_alm_1.Bit5 = 0;    //ALM_CELL_UV
    ch_alm_1.Bit6 = 0;    ch_alm_1.Bit7 = 0;    //ALM_CELL_OV
    //ALM_CELL_UT
    if(bms->slave_tcell_error_low[0]!=0){ch_alm_1.Bit1 = 0; ch_alm_1.Bit0 = 1;}
    else if(bms->slave_tcell_error_low[1]!=0){ch_alm_1.Bit1 = 1; ch_alm_1.Bit0 = 0;}
    else if(bms->slave_tcell_error_low[2]!=0){ch_alm_1.Bit1 = 1; ch_alm_1.Bit0 = 1;}
    //ALM_CELL_OT
    if(bms->slave_tcell_error_high[0]!=0){ch_alm_1.Bit3 = 0; ch_alm_1.Bit2 = 1;}
    else if(bms->slave_tcell_error_high[1]!=0){ch_alm_1.Bit3 = 1; ch_alm_1.Bit2 = 0;}
    else if(bms->slave_tcell_error_high[2]!=0){ch_alm_1.Bit3 = 1; ch_alm_1.Bit2 = 1;}
    //ALM_CELL_UV
    if(bms->slave_vcell_error_low[0]!=0){ch_alm_1.Bit5 = 0; ch_alm_1.Bit4 = 1;}
    else if(bms->slave_vcell_error_low[1]!=0){ch_alm_1.Bit5 = 1; ch_alm_1.Bit4 = 0;}
    else if(bms->slave_vcell_error_low[2]!=0){ch_alm_1.Bit5 = 1; ch_alm_1.Bit4 = 1;}
    //ALM_CELL_OV
    if(bms->slave_vcell_error_high[0]!=0){ch_alm_1.Bit7 = 0; ch_alm_1.Bit6 = 1;}
    else if(bms->slave_vcell_error_high[1]!=0){ch_alm_1.Bit7 = 1; ch_alm_1.Bit6 = 0;}
    else if(bms->slave_vcell_error_high[2]!=0){ch_alm_1.Bit7 = 1; ch_alm_1.Bit6 = 1;}
    
    ubyteMsg ch_alm_2;
    ch_alm_2.Bit0 = 0;    ch_alm_2.Bit1 = 0;    //ALM_BATT_OV    
    ch_alm_2.Bit2 = 0;    ch_alm_2.Bit3 = 0;    //ALM_BATT_DT
    ch_alm_2.Bit4 = 0;    ch_alm_2.Bit5 = 0;    //ALM_BATT_DV
    ch_alm_2.Bit6 = 0;                          //ALM_CELL_TBK ??
    ch_alm_2.Bit7 = 0;                          //ALM_CELL_LBK ??
    //ALM_BATT_OV
    if(bms->hv_monitoring_error_high[0]!=0){ch_alm_2.Bit1 = 0; ch_alm_2.Bit0 = 1;}
    else if(bms->hv_monitoring_error_high[1]!=0){ch_alm_2.Bit1 = 1; ch_alm_2.Bit0 = 0;}
    else if(bms->hv_monitoring_error_high[2]!=0){ch_alm_2.Bit1 = 1; ch_alm_2.Bit0 = 1;}
    //ALM_BATT_DT
    if(bms->slave_tcell_error_diff[0]!=0){ch_alm_2.Bit3 = 0; ch_alm_2.Bit2 = 1;}
    else if(bms->slave_tcell_error_diff[1]!=0){ch_alm_2.Bit3 = 1; ch_alm_2.Bit2 = 0;}
    else if(bms->slave_tcell_error_diff[2]!=0){ch_alm_2.Bit3 = 1; ch_alm_2.Bit2 = 1;}
    //ALM_BATT_DV
    if(bms->slave_vcell_error_diff[0]!=0){ch_alm_2.Bit5 = 0; ch_alm_2.Bit4 = 1;}
    else if(bms->slave_vcell_error_diff[1]!=0){ch_alm_2.Bit5 = 1; ch_alm_2.Bit4 = 0;}
    else if(bms->slave_vcell_error_diff[2]!=0){ch_alm_2.Bit5 = 1; ch_alm_2.Bit4 = 1;}
    
    ubyteMsg ch_alm_3;
    ch_alm_3.Bit0 = 0;    ch_alm_3.Bit1 = 0;    //ALM_CHRG_OCS ??    
    ch_alm_3.Bit2 = 0;    ch_alm_3.Bit3 = 0;    //ALM_BATT_UC
    ch_alm_3.Bit4 = 0;    ch_alm_3.Bit5 = 0;    //ALM_BATT_OC
    ch_alm_3.Bit6 = 0;    ch_alm_3.Bit7 = 0;    //ALM_BATT_UV
    //ALM_BATT_OC
    if(bms->hv_current_error_max[0] !=0){ch_alm_3.Bit5 = 0; ch_alm_3.Bit4 = 1;}
    else if(bms->hv_current_error_max[1] !=0){ch_alm_3.Bit5 = 1; ch_alm_3.Bit4 = 0;}
    else if(bms->hv_current_error_max[2] !=0){ch_alm_3.Bit5 = 1; ch_alm_3.Bit4 = 1;}
    //ALM_BATT_UV
    if(bms->hv_monitoring_error_low[0]!=0){ch_alm_3.Bit7 = 0; ch_alm_3.Bit6 = 1;}
    else if(bms->hv_monitoring_error_low[1]!=0){ch_alm_3.Bit7 = 1; ch_alm_3.Bit6 = 0;}
    else if(bms->hv_monitoring_error_low[2]!=0){ch_alm_3.Bit7 = 1; ch_alm_3.Bit6 = 1;}
    
    ubyteMsg ch_alm_4;
    ch_alm_4.Bit0 = 0;    ch_alm_4.Bit1 = 0;    //ALM_BSU_OFFLINE ??   
    ch_alm_4.Bit2 = 0;    ch_alm_4.Bit3 = 0;    //ALM_DSCH_OCT ??
    ch_alm_4.Bit4 = 0;    ch_alm_4.Bit5 = 0;    //ALM_CHRG_OCT ??
    ch_alm_4.Bit6 = 0;    ch_alm_4.Bit7 = 0;    //ALM_DSCH_OCS ??
    
    ubyteMsg ch_alm_5;
    ch_alm_5.Bit0 = 0;    ch_alm_5.Bit1 = 0;    //ALM_VCU_OFFLINE ??    
    ch_alm_5.Bit2 = 0;                          //ALM_BMU_FAIL ??
    ch_alm_5.Bit3 = 0;                          //ALM_AUX_FAIL ??
    ch_alm_5.Bit4 = 0;                          //ALM_PRECHRG_FAIL ??
    ch_alm_5.Bit5 = 0;    ch_alm_5.Bit6 = 0;    //ALM_LEAK_OC ??
    ch_alm_5.Bit7 = 0;                          //ALM_BSU_FAULT ??
    
    ubyteMsg ch_alm_6;
    ch_alm_6.Bit0 = 0;    ch_alm_6.Bit1 = 0;    ch_alm_6.Bit2 = 0;    ch_alm_6.Bit3 = 0;
    ch_alm_6.Bit4 = 0;    ch_alm_6.Bit5 = 0;    
    ch_alm_6.Bit6 = 0;    //ALM_HALL_BREAK ??
    ch_alm_6.Bit7 = 0;    //ALM_HVREL_FAIL ??

    

//HCU_INFO
    uint16_t data_info_1[2];
    data_info_1[0] = bms->BatVoltage;
    data_info_1[1] = bms->BatCurrent;
    uint8_t data_info_2[4];
    data_info_2[0] = bms->BatSoc;
    data_info_2[1] = bms->BatSoh;
    data_info_2[2] = ch_info.byte;  
    data_info_2[3] = bms->BatLife;
    can_send_msg_info(CAN_HCU_INFO_SID, CAN_HCU_INFO_EID, data_info_1, data_info_2);
    
//HCU_MAXV
    uint16_t data_mxv_1[2];
    data_mxv_1[0] = bms->MaxCelVolt;
    data_mxv_1[1] = bms->MinCelVolt;
    uint8_t data_mxv_2[2];
    data_mxv_2[0] = bms->MaxCelVoltNO;  
    data_mxv_2[1] = bms->MinCelVoltNO;  
    can_send_msg_mxv(CAN_HCU_MAXV_SID, CAN_HCU_MAXV_EID, data_mxv_1, data_mxv_2);
    
//HCU_MAXT
    uint8_t data_mxt[6];
    data_mxt[0] = bms->MaxTemp;
    data_mxt[1] = bms->MinTemp;
    data_mxt[2] = bms->MaxTempNO;
    data_mxt[3] = bms->MinTempNO;   
    data_mxt[4] = bms->CoolingCtl;
    data_mxt[5] = bms->HeatingCtl; 
    can_send_msg_mxt(CAN_HCU_MAXT_SID, CAN_HCU_MAXT_EID, data_mxt);
    
//HCU_RELAY
    //  ChrState ChrCommunication ChrOFFCC2 y ChrONCC están a 0
    uint8_t data_rly_1[3];
    data_rly_1[0] = ch_rly.byte;
    data_rly_1[1] = bms->OffChrRlyStr;
    data_rly_1[2] = ch_rly_2.byte;
    uint16_t data_rly_2[2];
    data_rly_2[0] = bms->ChrReqVoltage;
    data_rly_2[1] = bms->ChrReqCurrent;
    can_send_msg_rly(CAN_HCU_RELAY_SID, CAN_HCU_RELAY_EID, data_rly_1, data_rly_2);
    
//HCU_POWER
    uint16_t data_pwr[4];
    //data_pwr[0] = bms->MaxChrCurrLimit;
    uwordMsg MaxChrCurrLimit;
    MaxChrCurrLimit.Bit0 = 1;    MaxChrCurrLimit.Bit1 = 1;    MaxChrCurrLimit.Bit2 = 0;    MaxChrCurrLimit.Bit3 = 0;    
    MaxChrCurrLimit.Bit4 = 0;    MaxChrCurrLimit.Bit5 = 1;    MaxChrCurrLimit.Bit6 = 0;    MaxChrCurrLimit.Bit7 = 0;
    MaxChrCurrLimit.Bit8 = 0;    MaxChrCurrLimit.Bit9 = 0;    MaxChrCurrLimit.Bit10 = 0;   MaxChrCurrLimit.Bit11 = 0;    
    MaxChrCurrLimit.Bit12 = 0;   MaxChrCurrLimit.Bit13 = 0;   MaxChrCurrLimit.Bit14 = 0;   MaxChrCurrLimit.Bit15 = 0;
    data_pwr[0] = MaxChrCurrLimit.word;
    //data_pwr[1] = bms->MaxDisCurrLimit;
    uwordMsg MaxDisCurrLimit;
    MaxDisCurrLimit.Bit0 = 1;    MaxDisCurrLimit.Bit1 = 1;    MaxDisCurrLimit.Bit2 = 0;    MaxDisCurrLimit.Bit3 = 0;    
    MaxDisCurrLimit.Bit4 = 1;    MaxDisCurrLimit.Bit5 = 1;    MaxDisCurrLimit.Bit6 = 1;    MaxDisCurrLimit.Bit7 = 0;
    MaxDisCurrLimit.Bit8 = 0;    MaxDisCurrLimit.Bit9 = 0;    MaxDisCurrLimit.Bit10 = 0;   MaxDisCurrLimit.Bit11 = 0;    
    MaxDisCurrLimit.Bit12 = 0;   MaxDisCurrLimit.Bit13 = 0;   MaxDisCurrLimit.Bit14 = 0;   MaxDisCurrLimit.Bit15 = 0;
    data_pwr[1] = MaxDisCurrLimit.word;
    //data_pwr[2] = bms->MaxChrPowerLimit;
    uwordMsg MaxChrPowerLimit;
    MaxChrPowerLimit.Bit0 = 1;    MaxChrPowerLimit.Bit1 = 0;    MaxChrPowerLimit.Bit2 = 0;    MaxChrPowerLimit.Bit3 = 1;    
    MaxChrPowerLimit.Bit4 = 1;    MaxChrPowerLimit.Bit5 = 0;    MaxChrPowerLimit.Bit6 = 0;    MaxChrPowerLimit.Bit7 = 1;
    MaxChrPowerLimit.Bit8 = 0;    MaxChrPowerLimit.Bit9 = 0;    MaxChrPowerLimit.Bit10 = 0;   MaxChrPowerLimit.Bit11 = 0;    
    MaxChrPowerLimit.Bit12 = 0;   MaxChrPowerLimit.Bit13 = 0;   MaxChrPowerLimit.Bit14 = 0;   MaxChrPowerLimit.Bit15 = 0;
    data_pwr[2] = MaxChrPowerLimit.word;
    //data_pwr[3] = bms->MaxDisPowerLimit;
    uwordMsg MaxDisPowerLimit;
    MaxDisPowerLimit.Bit0 = 1;    MaxDisPowerLimit.Bit1 = 1;    MaxDisPowerLimit.Bit2 = 1;    MaxDisPowerLimit.Bit3 = 0;    
    MaxDisPowerLimit.Bit4 = 1;    MaxDisPowerLimit.Bit5 = 1;    MaxDisPowerLimit.Bit6 = 1;    MaxDisPowerLimit.Bit7 = 1;
    MaxDisPowerLimit.Bit8 = 1;    MaxDisPowerLimit.Bit9 = 0;    MaxDisPowerLimit.Bit10 = 0;   MaxDisPowerLimit.Bit11 = 0;    
    MaxDisPowerLimit.Bit12 = 0;   MaxDisPowerLimit.Bit13 = 0;   MaxDisPowerLimit.Bit14 = 0;   MaxDisPowerLimit.Bit15 = 0;
    data_pwr[3] = MaxChrPowerLimit.word;
    //can_send_msg_pwr(CAN_HCU_POWER_SID, CAN_HCU_POWER_EID, data_pwr);
    
//HCU_ALARM
    uint8_t data_alm[6];
    data_alm[0] = ch_alm_1.byte;
    data_alm[1] = ch_alm_2.byte;
    data_alm[2] = ch_alm_3.byte;
    data_alm[3] = ch_alm_4.byte;
    data_alm[4] = ch_alm_5.byte;
    data_alm[5] = ch_alm_6.byte;
    can_send_msg_alm(CAN_HCU_POWER_SID, CAN_HCU_POWER_EID, data_alm);
 
//CHARGER_INFO
    uint16_t data_chinfo_1[1];
    data_chinfo_1[0] = bms->MaxOutVoltage;
    uint8_t data_chinfo_2[3];
    data_chinfo_2[0] = ch_chinfo_1.byte;
    data_chinfo_2[1] = ch_chinfo_2.byte;
    data_chinfo_2[2] = ch_chinfo_3.byte;
    can_send_msg_chinfo(CHARGER_INFO_SID, CHARGER_INFO_EID, data_chinfo_1, data_chinfo_2);
...
//CHARGING_LIMITS
    ...
    //data_limits_2[0] = bms->ChrControl;
    ubyteMsg ChrControl;
    ChrControl.Bit0 = 1;    ChrControl.Bit1 = 0;    ChrControl.Bit2 = 0;    ChrControl.Bit3 = 0;    
    ChrControl.Bit4 = 0;    ChrControl.Bit5 = 0;    ChrControl.Bit6 = 0;    ChrControl.Bit7 = 0;
