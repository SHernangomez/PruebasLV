...
//Inicializar mensajes CAN carga
void charge_init(bms*bms){
    ...
    //HCU_RELAY
    bms->ChrReqCurrent = 5;
    bms->ChrReqVoltage = 571; 
    //bms->MaxChrCurrLimit = 35;  
    //bms->MaxDisCurrLimit = 115;
    //CHARGING_LIMITS
    bms->MaxChrVoltage = 5710;
    bms->MaxChrCurrent = 50;
    //CHARGER_INFO
    bms->MaxOutVoltage = 5750;   
}