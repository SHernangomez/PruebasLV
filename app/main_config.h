...
#define MIN_CELL_VOLTAGE_0 3000
#define MIN_CELL_VOLTAGE_1 3100
#define MIN_CELL_VOLTAGE_2 3200
...
#define MAX_CELL_DIFF_BALANCE 200
#define MAX_CYCLE_BALANCE 40
...
#define MIN_CELL_TEMP_0 10
#define MIN_CELL_TEMP_1 12
#define MIN_CELL_TEMP_2 15

#define MAX_TEMP_DIFF_0 10
...
#define CAN_HCU_ALARM_EID   0x140F3
...
#define CHARGER_INFO_SID 0x63F
#define CHARGER_INFO_EID 0x350E5
...
//HCU_MAXV
    uint16_t MaxCelVolt;
    uint16_t MinCelVolt;
    uint8_t MaxCelVoltNO;   
    uint8_t MinCelVoltNO;   
//HCU_MAXT
    uint8_t MaxTemp;
    uint8_t MinTemp;
    uint8_t MaxTempNO;      
